...
session_start();
 ?>
<form class="form-horizontal" onsubmit="GuardarUsuarioAdmin();return false;" id="FormModificacion" method="post" enctype="multipart/form-data" >
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        <button onclick="MostrarAdmin('adminTablaUsuarios')" id="btnCancelar" name="btnCancelar" class="btn btn-danger">Cancelar</button>
