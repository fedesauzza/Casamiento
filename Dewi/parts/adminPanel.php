<nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a onclick="MostrarAdmin('adminHome')"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                     <li>
                        <a  href="ui.html"><i class="fa fa-desktop fa-3x"></i> UI Elements</a>
                    </li>
                    <li>
                        <a onclick="MostrarAdmin('adminTablaUsuarios')"><i class="fa fa-qrcode fa-3x"></i> Usuarios</a>
                    </li>
						   <li  >
        ...
        <!-- /. NAV SIDE  -->
        <div id="page-wrapper" name="adminPanel" >
